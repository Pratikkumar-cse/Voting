...
contract Ballot {
    ...
    function propose() public  returns(bool){
        ...
        require(member.memberId(_address)>0,"not a member");
        require(!voting,"No proposal during voting");
        require(!candidate[_address].chk,"Already a Candidate");
        require(!member.certifierGetter(_address),"Already a Certifier");
        address to = _address;
    ...
    function winningProposal() onlyOwner public
    ...
    function Refresh() onlyOwner public {
